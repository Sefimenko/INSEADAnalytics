...
**I downloaded basic R package with called _jrvFinance_ that implements the basic financial analysis functions similar to (but not identical to) what is available in most spreadsheet software. Why? Because given all advantages of R language I still doubt how it can be used for sophisticated financial modelling of companies.**
...
Here are returns of the SPY in this period (note the use of the helper function pnl_plot - defined in file helpersSet1.R):
...
**3. Sorry, I can not. I tried to understand the code in dataSet1R to upload the results of Yahoo but I did not.**
...
**I have got "Error: object 'StockReturns' not found"" and I dont know how to find it**
<br>
<br>
<br>
...
**1. Probably, i need to change startDate = "2005-01-01" to "2001-01-01"**

**2. I have got "Error: object 'StockReturns' not found"" and I dont know how to find it**
<br>
...
**1. "Error: object 'StockReturns' not found""**
<br>
<br>
<br>
